...
%CSCPATH%csc.exe /target:library /out:"%OUTPATH%Debug\Multiverse.Server.exe" /recurse:"%SRVPATH%*.cs" /r:"%OUTPATH%Debug\Multiverse.dll" /nowarn:0618 /debug /nologo /optimize /unsafe

::##########

@DEL "%OUTPATH%Debug\Multiverse.Client.exe"

%CSCPATH%csc.exe /target:library /out:"%OUTPATH%Debug\Multiverse.Client.exe" /recurse:"%CLIPATH%*.cs" /r:"%OUTPATH%Debug\Multiverse.dll" /nowarn:0618 /debug /nologo /optimize /unsafe
...
%CSCPATH%csc.exe /target:library /out:"%OUTPATH%Release\Multiverse.Server.exe" /recurse:"%SRVPATH%*.cs" /r:"%OUTPATH%Release\Multiverse.dll" /nowarn:0618 /nologo /optimize /unsafe

::##########

@DEL "%OUTPATH%Release\Multiverse.Client.exe"

%CSCPATH%csc.exe /target:library /out:"%OUTPATH%Release\Multiverse.Client.exe" /recurse:"%CLIPATH%*.cs" /r:"%OUTPATH%Release\Multiverse.dll" /nowarn:0618 /nologo /optimize /unsafe
